...
namespace TestBinarBredly
{
    public partial class Form1 : Form
    {
        ...
        {
            System.Drawing.Imaging.BitmapData bmpData = imageOriginal.LockBits(new Rectangle(0, 0, width, height),
            ...
            unsafe
            {
                ...
                for (int i = 0; i < height; i++)
                {
                    ...
                    {
                        massByteImageOriginal[j, i] = *curpos++;
                    }
                }
            }
        ...
        {
            Bitmap picOut = new Bitmap(width, height, System.Drawing.Imaging.PixelFormat.Format8bppIndexed);
            System.Drawing.Imaging.BitmapData bmpData = picOut.LockBits(new Rectangle(0, 0, width, height),
        ...
        public void StartBradlyBinarization()
        {
            ...
            for (int i = 0; i < width; i++)
            {
                ...
                for (int j = 0; j < height; j++)
                {
                    ...
                    {
                        imageBinariz0or1[i, j] = 0x00;// Black
                        //imageBinariz0or1[i, j] = 0;
                    }
                    else
                    {
                        imageBinariz0or1[i, j] = 0xFF;// White
                        //imageBinariz0or1[i, j] = 1;
                    }
                }
            }
        }
